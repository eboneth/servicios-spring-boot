...
package com.eboneth.espec.empresa.utilidad.validacion;

import com.eboneth.espec.infraestructura.excepcion.ExcepcionValidacion;

public class TipoEmpresaValidacion {
    private static final int LONGITUD = 150;

    public TipoEmpresaValidacion() {
    }
    
    private static void validarNombreVacio(String nombre){
        if (nombre == null || nombre.trim().isEmpty()) {
            throw new ExcepcionValidacion("Nombre tipo de empresa es requerido");
        }
    }
